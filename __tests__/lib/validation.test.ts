import { validateField, validateForm, userValidationSchema } from '@/lib/validation'
...
describe('Validation Utils', () => {
  describe('validateField', () => {
    ...
    it('validates minLength', () => {
      ...
      expect(validateField('abc', rules)).toBe('Minimum length is 5 characters')
    ...
    it('validates maxLength', () => {
      ...
      expect(validateField('abcdef', rules)).toBe('Maximum length is 5 characters')
      expect(validateField('abcde', rules)).toBeUndefined()
    ...
    it('combines multiple rules', () => {
      ...
      expect(validateField('abcdefghijk', rules)).toBe('Maximum length is 10 characters')
      expect(validateField('ABC', rules)).toBe('Invalid format')
      expect(validateField('abc', rules)).toBeUndefined()
    })
  })
  ...
  describe('validateForm', () => {
    it('validates entire form', () => {
      const schema = {
        ...
        age: { custom: (value: any) => value < 18 ? 'Must be 18 or older' : undefined },
      }
  ...
  describe('userValidationSchema', () => {
    it('validates name field', () => {
      ...
      expect(validateField('J', schema.name)).toBe('Minimum length is 2 characters')
    ...
    it('validates email field', () => {
      ...
      expect(validateField('invalid-email', schema.email)).toBe('Please enter a valid email address')
      expect(validateField('user@domain', schema.email)).toBe('Please enter a valid email address')
    ...
    it('validates password field', () => {
      ...
      expect(validateField('12345', schema.password)).toBe('Minimum length is 6 characters')
    ...
    it('validates phone field', () => {
      ...
      expect(validateField('+1234567890', schema.phone)).toBeUndefined()
      expect(validateField('0123456789', schema.phone)).toBe('Please enter a valid phone number')
      expect(validateField('abc123', schema.phone)).toBe('Please enter a valid phone number')
    })
