...
describe("Users Store", () => {
  ...
  describe("getAll query", () => {
    it("should fetch users successfully", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.getAll.initiate({ page: 1 }),
      );
    ...
    it("should handle pagination parameters", async () => {
      ...
      await store.dispatch(
        users.endpoints.getAll.initiate({ page: 2, per_page: 10 }),
      );
  ...
  describe("getById query", () => {
    it("should fetch single user successfully", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.getById.initiate("1"),
      );
    ...
    it("should handle user not found", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.getById.initiate("999"),
      );
  ...
  describe("create mutation", () => {
    it("should create user successfully", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.create.initiate(newUser),
      );
    ...
    it("should handle validation errors", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.create.initiate(invalidUser),
      );
    ...
    it("should handle duplicate email error", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.create.initiate(duplicateUser),
      );
  ...
  describe("update mutation", () => {
    it("should update user successfully", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.update.initiate({ id: "1", data: updateData }),
      );
  ...
  describe("delete mutation", () => {
    ...
    it("should handle delete errors", async () => {
      ...
      const result = await store.dispatch(
        users.endpoints.delete.initiate("999"),
      );
  ...
  describe("caching behavior", () => {
    ...
    it("should use cache for subsequent queries", async () => {
      ...
      // Create user
      await store.dispatch(
        users.endpoints.create.initiate({
          name: "New User",
          email: "new@example.com",
          password: "password123",
          role_id: "1",
  ...
  describe("loading states", () => {
    it("should track loading state for queries", async () => {
      ...
      const finalQueryState =
        finalState[users.reducerPath].queries['getAll({"page":1})'];
    ...
    it("should track loading state for mutations", async () => {
      ...
      const state = store.getState();
      const mutationState =
        state[users.reducerPath].mutations[
          Object.keys(state[users.reducerPath].mutations)[0]
        ];
      ...
      // Check final state
      const finalState = store.getState();
      const finalMutationState =
        finalState[users.reducerPath].mutations[
          Object.keys(finalState[users.reducerPath].mutations)[0]
        ];
